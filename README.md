...
**To view the processed data, either navigate to the csv file created (directory listed in L1filepath variable of main_interval_proc.py file) or copy and paste the link shown in the Terminal to your browser (Should look something like http://0.0.0.0:8080/)**

**For additional information about the PoLRa sensor setup, see the user_manual.pdf file in this repository.**
**To learn more about the sensor technology and how it was created, visit https://terraradtech.com/technology/**
